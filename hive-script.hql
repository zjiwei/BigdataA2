...
CREATE EXTERNAL TABLE hiveresult (gram STRING, total_occurences FLOAT, total_books FLOAT, average_occurences FLOAT, first_year INT, last_year INT, total_records INT) ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t' LOCATION  '/user/hadoop/hive_result/'; 

INSERT OVERWRITE TABLE hiveresult 
